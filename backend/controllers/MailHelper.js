...
const iconPNG=process.env.LOGO
...
function ObtenerMailDeRecordatorio(Nombres,Apellidos,Medico,Bloque,Fecha_cita){
    ...
    "<div>&nbsp;</div></div></div><p style=\'text-align: left;\' >Si quiere ver más en detalle su cita puede hacerlo en nuestra página <a href=\"http://localhost:3000\"> Reservas.cl</a></p>"
    console.log(mensaje)
    return mensaje;
}
module.exports= {ObtenerMailDeRecordatorio}